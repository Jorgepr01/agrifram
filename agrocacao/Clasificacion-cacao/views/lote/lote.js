    ...
    var table = $('#example').DataTable({
        ...
        "columns": [
            ...
            
            {
    			...
    			"render": function(data, type, row) {
        			...
        			return '<div class="switcher">' +
                   			 '<input type="checkbox" class="estado-switcher" data-id="' + row.id_lote + '" name="switcher_checkbox_' + row.id_lote + '" id="switcher_checkbox_' + row.id_lote + '" value="1" ' + isChecked + '>' +
                   			 '<label for="switcher_checkbox_' + row.id_lote + '"></label>' +
               			   '</div>' 
			...
			},
            {
    			...
    			"render": function(data, type, row) {
        			return  '<div>' +
                   		   	 '<button class="edit-btn" data-id="' + row.id_lote + '" style="margin-right: 5px; color:#efad25"><i class="fa fa-edit"></i></button>' +
               			   '</div>'; 
