...
<head>
    ...
    <title>Inicio | Tratamiento</title>
    ...
    <div id="page-container" class="page-container fade page-sidebar-fixed page-header-fixed">
        ...
        <div id="content" class="content">
            ...
            <ol class="breadcrumb float-xl-right">
                ...
                <li class="breadcrumb-item"><a href="./index.php">Tratamiento</a></li>
            </ol>
            <!-- end breadcrumb -->


            <!-- begin page-header -->
            <h1 class="page-header">Tratamiento</h1>
            <!-- end page-header -->
            ...
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    <h4 class="panel-title">Tratamiento</h4>
