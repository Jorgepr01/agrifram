    ...
    "columns": [
        ...
        { "data": "medida_manejo"},
        {
            ...
            "render": function(data, type, row) {
                return '<button class="edit-btn" data-id="' + row.id_estado_cacao + '" style="margin-right: 5px; color:#efad25"><i class="fa fa-edit"></i></button>'
                    //'<button class="delete-btn" data-id="' + row.id_estado_cacao + '" style="margin-right: 5px; color:red"><i class="fa fa-trash"></i></button>';
            }
        }
    ],
    "language": {
